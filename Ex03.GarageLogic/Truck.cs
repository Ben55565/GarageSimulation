...
namespace Ex03.GarageLogic
{
    internal class Truck : Vehicle
    {
        ...
        public Truck(Vehicle i_VehicleBasicDetails, bool i_TransportWithCooling, float i_MaxCargoWeight, FueledVehicleDetails i_FueledVehicleDetails)
            : base(i_VehicleBasicDetails.m_ModelName, i_VehicleBasicDetails.RegistrationId, i_VehicleBasicDetails.m_EnergyPercentageLeft, i_VehicleBasicDetails.m_Wheels, i_VehicleBasicDetails.OwnerDetails, i_FueledVehicleDetails)
        {
