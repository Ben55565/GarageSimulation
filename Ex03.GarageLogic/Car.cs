...
namespace Ex03.GarageLogic
{
    public class Car
    {
        ...
        {
            string output = string.Format(Environment.NewLine + r_BasicDetails.ToString() + "======== Car details ========" + Environment.NewLine + Environment.NewLine + "Car color: {0}" + Environment.NewLine + "Number of doors: {1}", r_CarColor, r_NumOfDoors);
            return output;
        }
    }
}